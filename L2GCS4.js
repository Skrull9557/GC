...
function createCourseInputs() {
    ...
    const coefficients = {
        "matriaux de construction": 1,
        "Mécanique des soles": 2,
        "Mathématiques 4": 2,
        "methodes numeriques": 2,
        "resistance des materiaux": 2,
        "TP Mécanique des soles": 1,
        "TP matriaux de construction": 1,
        "dessin assiste par ordinateur": 1,
        "TP methodes numeriques": 1,
        "TP mdf et rdm": 1,
        "geologie": 1,
        "topographie 1": 1,
        "Techniques d’information d’expression et de communication ": 1,
    };
