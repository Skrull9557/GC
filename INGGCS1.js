...
function createCourseInputs() {
    ...
    const coefficients = {
        "Analyse 1": 3,
        "Algèbre 1": 2,
        "Eléments de Chimie(structure de la matière)": 4,
        "Eléments de Mécanique (Physique 1) ":4,
        "Probabilités et statistiques": 2,
        "Structure des ordinateurs et applications ": 2,
        "Dimension éthique et déontologique(Les fondements) ":1,
        "Langue étrangère 1 (Français ou Anglais) ": 1,
    };
